...
import net.remclean.mapleforest.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>())
                    .put(ModArmorMaterials.ARMOR_PAD, new StatusEffectInstance(StatusEffects.SPEED, 20, 1,
                            false, false, false)).build();
    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP_2 =
            (new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>())
                    .put(ModArmorMaterials.ARMOR_PAD, new StatusEffectInstance(StatusEffects.STRENGTH, 20, 1,
                            false, false, false)).build();
